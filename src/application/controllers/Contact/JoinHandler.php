...
class JoinHandler extends ContactHandler 
{
  ...
  protected function get_subject()
  {
	...
	protected function get_mail_body()
	{
		...
		$communication = 
			$this->get_checkbox_str("con_by_tel", "電話").
			$this->get_checkbox_str("con_by_email", "Eメール").
			$this->get_checkbox_str("no_con", "連絡不要");

		$send = 
			$this->get_checkbox_str("send_by_mail", "ご郵送").
			$this->get_checkbox_str("send_by_email", "Eメール");
