...
<div id="main">
  ...
  <div class="rightbar">
    ...
    <p>
    下記のフォームより、必要事項をご入力の上、ご希望のロール紙個数を注文いただきますようお願い致します。ご発注いただいてから、約1週間程度でご送付させていただきます。
    </p>
    <p>
    ...
    <br /><br />
    ※PAX端末以外（INFOX/CARDNET）のロール紙の注文はお受付ができません
    </p>
    ...
    <form method="post" action="" name="form1">
      <div class="_table">
        ...
        <div class="_tr">
          <div class="_td td_label">[2]端末識別番号<span class="required">（必須）</span></div>
          <div class="_td td_input">
        ...
        <div class="_tr">
          <div class="_td td_label">[5]送付先住所</div>
          <div class="_td td_input">
            <div class="row">
              <div class="col-xs-4">
        ...
        <div class="_tr" id="tr-addr-txt">
          ...
          <div class="_td td_input">
            <textarea rows="5" id="addr_txt" name="addr_txt" placeholder="※その他住所にチェックされた方は、必ずご入力ください"></textarea>
          </div>
        </div>


        <div class="_tr">
          <div class="_td td_label">[6]S80（58mmx48Φ）</div>
          <div class="_td td_input">
            <div class="row">
              <div class="col-xs-4">
        ...
        <div class="_tr">
          <div class="_td td_label">[7]S90（58mmx30Φ）</div>
          <div class="_td td_input">
            <div class="row">
              <div class="col-xs-4">
        ...
        <div class="_tr">
          <div class="_td td_label">[8]備考</span></div>
          <div class="_td td_input">
            <textarea type="text" rows="5" id="remark" name="remark"></textarea>
          </div>
        </div>
