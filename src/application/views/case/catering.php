...
<div class="row">
  <div class="col-sm-3 sidebar">
    <ul>
      ...
      <li class="active"><a href="<?php echo $base_path;?>cases/catering">飲食</a></li>
      <li><a href="<?php echo $base_path;?>cases/beauty">美容</a></li>
      <li><a href="<?php echo $base_path;?>cases/automobile">自動車関連</a></li>
    </ul>
  </div>
  ...
  <div class="col-sm-9">
    ...
    <div class="row">
      <div class="row_left">
        <img class="media-object img-responsive" src="<?php echo $cdn_path;?>images/cases/catering1.png">
      </div>
      <div class="row_right">
    ...
    <div class="row">
      ...
      <div class="row_right">
        <img class="media-object img-responsive" src="<?php echo $cdn_path;?>images/cases/catering2.png">
      </div>
    </div>

    <div class="row">
      <div class="row_left">
        <img class="media-object img-responsive" src="<?php echo $cdn_path;?>images/cases/catering3.png">
      </div>
      <div class="row_right">
